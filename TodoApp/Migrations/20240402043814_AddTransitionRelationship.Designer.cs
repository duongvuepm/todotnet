...
namespace TodoApp.Migrations
{
    ...
    [Migration("20240402043814_AddTransitionRelationship")]
    partial class AddTransitionRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoApp.Models.Transition", b =>
                {
                    b.HasOne("TodoApp.Models.State", "FromState")
                        .WithMany("Transitions")
                        .HasForeignKey("FromStateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TodoApp.Models.State", "ToState")
                        .WithMany()
